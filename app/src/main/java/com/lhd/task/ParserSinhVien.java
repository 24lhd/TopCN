...
import static com.lhd.duong.ChucNangPhu.getJSONByObj;
...
//                SinhVien sinhVien=null;
                ...
                if (sinhVien.getMa().isEmpty()) sinhVien=config.getArraySinhVienByJson((new DuongHTTP()).getHTTP(GET_SV+params[0])).get(0);
                return sinhVien;
            } catch (Exception e) {
